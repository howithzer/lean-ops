...
class Config:
    ...
    def get_table_path(self, database: str, table_name: str) -> str:
        """
        Helper to construct a fully qualified Iceberg table name dynamically.
        Example: config.get_table_path(config.curated_database, 'transactions')
        -> 'glue_catalog.iceberg_curated_db.transactions'
        """
